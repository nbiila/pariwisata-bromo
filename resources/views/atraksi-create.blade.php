        ...
        <div class="col-lg-6">
            <div class="card form-card">
                ...
                <div class="form-header">
                    ...
                    <p>Lengkapi data atraksi wisata di bawah ini</p>
                </div>
                ...
                <select name="destinasi_id" class="form-select @error('destinasi_id') is-invalid @enderror">
                     <option value="" selected disabled>-- Pilih Destinasi --</option>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="role-options">
                                <div class="role-option">
                                    <input type="radio" name="kategori" id="kategori-budaya" value="Budaya" {{ old('kategori') == 'Budaya' ? 'checked' : '' }}>
                                    <label for="kategori-budaya"><i class="bi bi-mask"></i> Budaya</label>
                                </div>
                                <div class="role-option">
                                    <input type="radio" name="kategori" id="kategori-alam" value="Alam" {{ old('kategori') == 'Alam' ? 'checked' : '' }}>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-bromo">Simpan Atraksi</button>
